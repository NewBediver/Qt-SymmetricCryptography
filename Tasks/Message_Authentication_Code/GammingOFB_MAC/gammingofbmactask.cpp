#include "gammingofbmactask.h"

#include <QBitArray>
#include <QByteArray>

GammingOFBMACTask::GammingOFBMACTask(QWidget *parent) : MainTask(parent)
{
...
void GammingOFBMACTask::mainMethod()
{
    // Get key
    ...
    for (int numOfBlock = 0; numOfBlock < numOfBlocks; ++numOfBlock) {
        ...
        QBitArray N4(32);
        for (int i = 0; i < 32; ++i) {
            N3.setBit(i, encodedGamma.at(31 - i));
            N4.setBit(i, encodedGamma.at(63-i));
        }
...
GammingOFBMACTask::~GammingOFBMACTask() {}
