...
QBitArray EncodeGammingTask::summatorCM1mod2pow32(const QBitArray& N1, const QBitArray& X)
{
    QBitArray res(N1);
...
QBitArray EncodeGammingTask::kTransformBlock(const QBitArray& N1, const unsigned char S[8][16])
{
    QBitArray res(32);
...
QBitArray EncodeGammingTask::rRotation11Block(const QBitArray& N1)
{
    QBitArray res(32);
...
QBitArray EncodeGammingTask::summatorCM2mod2pow1(const QBitArray& N1, const QBitArray& N2)
{
    QBitArray res(N1);
    res ^= N2;
    return res;
...
QBitArray EncodeGammingTask::summatorCM4mod2pow32minus1(const QBitArray& N4, const QBitArray& C1)
{
    QBitArray res(N4);
...
QBitArray EncodeGammingTask::summatorCM3mod2pow32(const QBitArray& N3, const QBitArray& C2)
{
    QBitArray res(N3);
...
QBitArray EncodeGammingTask::summatorCM5mod2(const QBitArray& N1, const QBitArray& N2, const QBitArray& text1, const QBitArray& text2)
{
    QBitArray res(64);
    for (int i = 0; i < 32; ++i) {
        res[i] = N1[i] ^ text1[i];
...
QBitArray EncodeGammingTask::getInitializingVector(const QByteArray& keyArray)
{
