...
void DecodeElectronicCodeBookTask::mainMethod()
{
    ...
    resultTextEdit->setText(res);
}

QBitArray DecodeElectronicCodeBookTask::summatorCM1mod2pow32(const QBitArray& N1, const QBitArray& X)
{
    QBitArray res(N1);
...
QBitArray DecodeElectronicCodeBookTask::kTransformBlock(const QBitArray& N1, const unsigned char S[8][16])
{
    QBitArray res(32);
...
QBitArray DecodeElectronicCodeBookTask::rRotation11Block(const QBitArray& N1)
{
    QBitArray res(32);
...
QBitArray DecodeElectronicCodeBookTask::summatorCM2mod2pow1(const QBitArray& N1, const QBitArray& N2)
{
    QBitArray res(N1);
    res ^= N2;
    return res;
