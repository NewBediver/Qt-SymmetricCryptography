...
QBitArray EncodeCipherBlockChaining::summatorCM1mod2pow32(const QBitArray& N1, const QBitArray& X)
{
    QBitArray res(N1);
...
QBitArray EncodeCipherBlockChaining::kTransformBlock(const QBitArray& N1, const unsigned char S[8][16])
{
    QBitArray res(32);
...
QBitArray EncodeCipherBlockChaining::rRotation11Block(const QBitArray& N1)
{
    QBitArray res(32);
...
QBitArray EncodeCipherBlockChaining::summatorCM2mod2pow1(const QBitArray& N1, const QBitArray& N2)
{
    QBitArray res(N1);
    res ^= N2;
    return res;
...
QBitArray EncodeCipherBlockChaining::getInitializingVector(const QByteArray& keyArray)
{
...
void EncodeCipherBlockChaining::xorR1WithN1AndN2(const QBitArray& R1, QBitArray& N1, QBitArray& N2)
{
...
QBitArray EncodeCipherBlockChaining::getNewR1FromCi(const QBitArray& N1, const QBitArray& N2)
{
    QBitArray res(64);
    int index = 0;
